...
{
    public class GetMatchResultValidator : AbstractValidator<GetMatchResult>
    {
        private string _badPlayerInfoMessage;

        public GetMatchResultValidator()
        {
        ...
        private bool BeValid(List<List<GetMatchPlayerInfo>> teams)
        {
            var validator = Validator.Get<GetMatchPlayerInfo>();
        ...
        private bool HaveTheRightMemberCount(GetMatchResult command, List<List<GetMatchPlayerInfo>> teams)
        {
